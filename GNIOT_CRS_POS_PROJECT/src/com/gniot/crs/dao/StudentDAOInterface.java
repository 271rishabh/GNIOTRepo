...
public interface StudentDAOInterface {
	 ...
	 *
	 *  studentId the ID of the student whose account information is to be
	 *                  retrieved
	 *  a StudentDetails object containing the student's account information
	 */
	 ...
	 *
	 *  studentId the ID of the student enrolling in the course
